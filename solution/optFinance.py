...
input = open("D:/CS787/Project/cs787_ha3_supp_manuf_transp_sn_template 2 (2)/cs787_ha3_supp_manuf_transp_sn_template 2/cs787_ha3_supp_manuf_transp_sn_template/project/finance.json", "r")
...
def findQuantity(category, cost):
    qty = cost / (sharedData["entities"]["finance"][category]["cost_per_hour"] * inputData["data"]["current"][category]["hour_per_day"])
    return int(qty)


percent = optInput["finance"]
...
f = open("answers/outOptFinance.json","w")
