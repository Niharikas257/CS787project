...
def findQuantity(category, cost):
    cost_per_hour = sharedData["entities"]["legal"][category]["cost_per_hour"]
...
with open("answers/outOptLegal.json", "w") as f:
    json.dump(output, f)
